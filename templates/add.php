        ...
        <div class="adding-post container">
            ...
            <div class="adding-post__tabs-wrapper tabs">
                <div class="adding-post__tabs filters">
                    ...
                    $active_tab = $_GET['post_type'];
                    } ?>
                    <?php foreach ($content_type_arr as $type): ?>
                        <li class="adding-post__tabs-item filters__item">
                            <a href="add.php?post_type=<?= $type['class_name']; ?>" class="adding-post__tabs-link filters__button filters__button--<?= $type['class_name']; ?>
                            <?= ($active_tab === $type['class_name']) ? 'filters__button--active tabs__item--active tabs__item' : ''; ?>   button">
                            ...
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    <div class="adding-post__input-wrapper form__input-wrapper">
                                        <label class="adding-post__label form__label" for="name">Заголовок <span class="form__input-required">*</span></label>


                                        <?php $classname = isset($errors['title']) ? 'form__input-section--error' : ""; ?>
                                        <div class="form__input-section <?= $classname; ?>">
                                            <input class="adding-post__input form__input" id="name" type="text" name="title" placeholder="Введите заголовок"
