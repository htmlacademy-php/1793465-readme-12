<main class="page__main page__main--publication">
    <div class="container">
        <h1 class="page__title page__title--publication"> <?= $post_active['title']; ?> </h1>
        <section class="post-details">
            <h2 class="visually-hidden">Публикация</h2>
            <div class="post-details__wrapper post-photo">
                <div class="post-details__main-block post post--details">
                    <?php switch ($post_active['content_type_id']):
                        case "2": ?>
                            <!-- пост-цитата -->
                            <div class="post-details__image-wrapper post-quote">
                                <div class="post__main">
                                    <blockquote>
                                        <p>
                                            <?= $post_active['text_quote']; ?>
                                        </p>
                                        <cite><?= $post_active['author_quote']; ?></cite>
                                    </blockquote>
                                </div>
                            </div>
                        <?php break;
                                    ...
                                    <a class="post-link__external" href="http://<?= $url; ?>" title="Перейти по ссылке">
                                        <div class="post-link__info-wrapper">
                                            <div class="post-link__icon-wrapper">
                                                <img src="https://www.google.com/s2/favicons?domain=<?= $post_active['site_link']; ?>" alt="Иконка">
                                            </div>
                                            <div class="post-link__info">
                                                <h3><?= $post_active['site_link']; ?></h3>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                    ...
                    <div class="post-details__user-info user__info">
                        <div class="post-details__avatar user__avatar">
                            <a class="post-details__avatar-link user__avatar-link" href="#">
                                <img class="post-details__picture user__picture" src="img/<?= $post_active['avatar_link']; ?>" alt="Аватар пользователя">
                            </a>
                        </div>
                        <div class="post-details__name-wrapper user__name-wrapper">
                            <a class="post-details__name user__name" href="#">
                                <span><?= $post_active['login']; ?></span>
                            </a>
